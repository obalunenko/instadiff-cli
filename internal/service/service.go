...
func (svc *Service) UnFollow(user models.User) error {
	...
	us := goinsta.User{
		Collections:                &goinsta.Collections{},
		ID:                         user.ID,
		...
		BiographyProductMentions:       []interface{}{},
		IsNeedy:                        false,
		...
		FollowFrictionType:             0,
		ProfileContext:                 "",
		HasBiographyTranslation:        false,
		HasSavedItems:                  false,
		Nametag:                        goinsta.Nametag{},
		HasChaining:                    false,
		IsFavorite:                     false,
		...
		ShowInsightTerms:               false,
		ShowConversionEditEntry:        false,
		ShowPostsInsightEntryPoint:     false,
		ShoppablePostsCount:            0,
		RequestContactEnabled:          false,
		...
		AllowMentionSetting:                  "",
		AllowTagSetting:                      "",
		LimitedInteractionsEnabled:           false,
		ReelAutoArchive:                      "",
		HasHighlightReels:                    false,
		HightlightReshareDisabled:            false,
		...
		AllowedToCreateNonprofitFundraisers:  false,
		AllowedToCreatePersonalFundraisers:   false,
		IsElegibleToShowFbCrossSharingNux:    false,
		PageIdForNewSumaBizAccount:           New,
		ElegibleShoppingSignupEntrypoints:    []interface{}{},
		IsIgdProductPickerEnabled:            false,
		IsElegibleForAffiliateShopOnboarding: false,
		IsElegibleForSMBSupportFlow:          false,
		ElegibleShoppingFormats:              []interface{}{},
		NeedsToAcceptShoppingSellerOnboardingTerms: false,
		SellerShoppableFeedType:                    "",
		VisibleProducts:                            0,
		IsShoppingCatalogSettingsEnabled:           false,
		IsShoppingCommunityContentEnabled:          false,
		IsShoppingAutoHighlightEnabled:             false,
		IsShoppingCatalogSourceSelectionEnabled:    false,
		ProfessionalConversionSuggestedAccountType: 0,
		InteropMessagingUserfbid:                   0,
		LinkedFbInfo:                               struct{}{},
		HasElegibleWhatsappLinkingCategory:         struct{}{},
		ExistingUserAgeCollectionEnabled:           false,
		AboutYourAccountBloksEntrypointEnabled:     false,
		OpenExternalUrlWithInAppBrowser:            false,
